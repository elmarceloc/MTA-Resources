...
function( )
	...
	dxDrawText( #players .. "/500", posX, posY, posX + width - 10, posY + h_height, tocolor( 255, 255, 255, 255 ), 1, font, "right", "center", false, false, true )
	...
	dxDrawText(  "$".. convertNumber( getPlayerMoney( ) ).. " Pesos", headerX + 20, headerY + 20, headerX + 20, headerY + 36, tocolor( 255, 255, 255, 255 ), 0.55, font, "left", "center", false, false, true )
	...
	dxSetRenderTarget( renderTarget, true )
		...
		for i = 1, #players do
			...
			if distance > 1000 then
				distance_txt = 'A la chucha'
			elseif distance < 3 then
				distance_txt = 'Al lado'
			else
				distance_txt = 'A ' .. math.floor(distance) .. ' Metros'
			end
			...
			dxDrawImage( 10,  (i-1)*38+6, 32, 32, "files/skins/" .. getElementModel( players[ i ] ) .. ".png", 0, 0, 0, tocolor( 255, 255, 255, 255 ), false )
		
			dxDrawImage( 300,  (i-1)*38+6, 28, 28, "egg.png", 0, 0, 0, tocolor( 255, 255, 255, 255 ), false )
			dxDrawText( getElementData(players[i],'eggs') , 300+28+8, posY, 160, posY + r_height, tocolor( r, g, b, 255 ), 0.6, font, "left", "center" )
			...
			if  players[ i ] ~= localPlayer then
				dxDrawText( distance_txt , 200, posY, 160, posY + r_height, tocolor( r, g, b, 255 ), 0.6, font, "left", "center" )
			end
