...
local tstgs = {
  text = "Presiona '"..bdKey[ 1 ].."' para entrar a la cabina.",       -- Text that will show up when cabin gets closer to a player
  ...
  for i, col in ipairs( t ) do
    addEventHandler( 'onClientColShapeHit', col, function( player, dim )
      if player == localPlayer and dim then
        ...
        tstgs.text = "Presiona '"..bdKey[ 1 ].."' para entrar de la cabina.";
