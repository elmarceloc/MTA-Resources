        ...
        if #dxGrid.items > 0 then
            ...
            for index, data in ipairs ( dxGrid.items ) do
                ...
                if data.vis then
                    ...
                    -- Draw the column bar
                    dxDrawRectangle ( data.x, data.y, data.w, 30 % data.h, tocolor ( 23, 225, 167, 255 ), data.pg );
                    ...
                    local cWidth = 0
                        ...
                        for cIndex, cData in ipairs ( data.i ) do
                            ...
                            if ( ( cWidth + cData.info.width ) <= data.w ) then
                                ...
                                dxDrawText ( cData.info.title, x, data.y, cData.info.width + x, ( 30 % data.h ) + data.y, tocolor ( 0, 0, 0 ), FIT_MODE and ( 1.5 * SCALE ) or 1.5, "default-bold", "center", "center", true, true, data.pg, false, true );
