		...
		["subMenu"] = {
			[1] = {
				...
				["subMenu"] = {
					...
					[4] = {["categoryName"] = getLocalizedText("tuningPack.3"), ["tuningPrice"] = 0, ["tuningData"] = {{"engineAcceleration", 8}, {"maxVelocity", 30}}}
				}
			},
			[2] = {
				...
				["subMenu"] = {
					...
					[4] = {["categoryName"] = getLocalizedText("tuningPack.3"), ["tuningPrice"] = 0, ["tuningData"] = {{"engineInertia", -30}}}
				}
			},
			[3] = {
